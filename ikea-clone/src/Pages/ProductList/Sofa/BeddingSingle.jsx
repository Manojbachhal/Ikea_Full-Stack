            ...
            <div className="d-flex">
              <div style={{ width: "50%", transition: ".2s ease-in-out" }}>
                ...
                <img
                  ...
                  onMouseOver={(e) =>
                    (e.currentTarget.src = contextualImageUrl)
                  }
                  onMouseLeave={(e) => (e.currentTarget.src = mainImageUrl)}
                  id="temp"
                />
              </div>
              <div style={{ width: "50%", transition: "0.5s" }}>
                ...
                <div className="d-flex  my-4 gap-4">
                  <img
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTS928i97c7uYqrtEvKs-Gl3HMY5UAfsYHGAw&usqp=CAU"
                    alt=""
                    style={{
                      width: "5%",
                      height: "5%",
                ...
                <button
                  className=" fw-bold border-2  rounded-pill p-2 px-4 mb-2 text-light"
                  style={{
                    letterSpacing: "1px",
                    background: "#0058AB",
