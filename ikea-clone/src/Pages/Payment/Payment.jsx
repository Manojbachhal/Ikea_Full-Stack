...
function Payment(props) {
  ...
  async function AddData() {
    ...
    let res = await axios.post(
      "https://ikea-backend.onrender.com/products/cart/empty-cart",
      {
        token,
      }
    );
                ...
                <div id="border_select" style={{ padding: "10px" }}>
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <button id="question_btn" style={{ margin: "20px" }}>
                        ?
                      </button>
                    </div>
                  </div>
        ...
        <div id="parent_payment_right">
                ...
                return (
                  <div style={{ borderTop: "1px solid black" }}>
                    ...
                    <div style={{ marginLeft: "20px" }}>
                      ...
                      <div>
                        <b style={{ fontWeight: "540", fontSize: "15px" }}>
                          {" "}
                          Quantity :{" "}
                        </b>
                        {elem.qantity}
                      ...
                      <div>
                        {" "}
                        ₹ <span>{elem.salesPrice_numeral}</span>{" "}
                      </div>
                    </div>
                  </div>
                );
          ...
          <div id="ammountDiv" className="flexdata">
            ...
            <button>
              {" "}
              ₹{" "}
              <span id="totalamt" style={{ fontSize: "20px" }}>
                {" "}
                <b> {totalAmount} </b>{" "}
              </span>
            </button>
